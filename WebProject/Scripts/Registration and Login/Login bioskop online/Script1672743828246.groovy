...
WebUI.setText(findTestObject('Page_Bioskop Online/input_Atau_username'), 'ira13z@wandahadissuara.com')

WebUI.setText(findTestObject('Page_Bioskop Online/input__password_login'), 'Katasand1')
