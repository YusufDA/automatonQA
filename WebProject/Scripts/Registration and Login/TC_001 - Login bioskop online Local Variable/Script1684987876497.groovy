...
WebUI.setText(findTestObject('Page_Bioskop Online/input_Atau_username'), username)

WebUI.setText(findTestObject('Page_Bioskop Online/input__password_login'), password)
